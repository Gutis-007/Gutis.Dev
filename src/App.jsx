...
import { FiArrowUpRight, FiBriefcase, FiDownload, FiGithub, FiLinkedin, FiMail, FiMapPin, FiMenu, FiX } from 'react-icons/fi';
import { FaPython, FaReact } from 'react-icons/fa6';
import { SiDjango, SiNextdotjs, SiFlutter, SiJavascript, SiTypescript, SiTailwindcss } from 'react-icons/si';
import './App.css';
...
const skills = [
  ['Front-end', 'React, Next.js, JavaScript, TypeScript', <FaReact key="front-end" />], ['Back-end', 'Python, Django, APIs REST', <SiDjango key="back-end" />],
  ['Mobile', 'Flutter e Dart', <SiFlutter key="mobile" />], ['Produto', 'Figma, Git, AWS, Scrum/Kanban', <FiBriefcase key="produto" />],
];
